                                    ...
                                    @forelse ($items as $item)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @endif
                                                <a href="#myModal" class="btn btn-info btn-sm" data-remote="{{ route('transactions.show', $item->id) }}" data-toggle="modal" data-target="#myModal" data-title="Detail Transaksi {{ $item->uuid }}">
                                                    <i class="fa fa-eye"></i>
                                                </a>
